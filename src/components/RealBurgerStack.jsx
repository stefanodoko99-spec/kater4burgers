...
const STACKS = {
  bloom: [
    ['bloom-01-top-bun.webp', 'Brioche top bun', 1],
    ['bloom-02-tomato.webp', 'Tomato', 34],
    ['bloom-03-american-cheddar.webp', 'American cheddar', 41],
    ['bloom-04-smash-beef.webp', 'Smash beef', 46],
    ['bloom-05-lettuce.webp', 'Lettuce', 52],
    ['bloom-06-bottom-bun.webp', 'Bottom bun', 56],
  ],
  jalapenos: [
    ['jalapenos-01-top-bun.webp', 'Brioche top bun', 0],
    ['jalapenos-02-jalapenos.webp', 'Jalapeños', 34],
    ['jalapenos-03-herb-cream-sauce.webp', 'Herb cream sauce', 41],
    ['jalapenos-04-american-cheese.webp', 'American cheese', 43],
    ['jalapenos-05-smash-beef.webp', 'Smash beef', 50],
    ['jalapenos-06-bottom-bun.webp', 'Bottom bun', 57],
  ],
  oklahoma: [
    ['oklahoma-01-top-bun.webp', 'Brioche top bun', 0],
    ['oklahoma-02-american-cheddar.webp', 'American cheddar', 40],
    ['oklahoma-03-smash-beef.webp', 'Smash beef', 48],
    ['oklahoma-04-caramelized-onions.webp', 'Caramelized onions', 55],
    ['oklahoma-05-bottom-bun.webp', 'Bottom bun', 58],
  ],
  classic: [
    ['classic-ai-01-top-bun.webp', 'Brioche top bun', -7],
    ['classic-ai-02-pickles.webp', 'Pickles', 31],
    ['classic-ai-03-cheddar.webp', 'American cheddar', 34],
    ['classic-ai-04-smash-beef.webp', 'Smash beef', 43],
    ['classic-ai-05-house-sauce.webp', 'House sauce', 47],
    ['classic-ai-06-bottom-bun.webp', 'Bottom bun', 50],
  ],
}
